...
// Dominos menu
const dominosMenu = [
  { id: '1', name: 'Margherita Pizza', image: require('./im/neapolitanpizza.jpg'), price: 10 },
  { id: '2', name: 'Pepperoni Pizza', image: require('./im/newyarkpizza.jpg'), price: 12 },
  { id: '3', name: 'Veggie Burger', image: require('./im/veggieburger.jpg'), price: 6 },
  { id: '4', name: 'Cheese Burger', image: require('./im/b1.jpg'), price: 5 },
  { id: '5', name: 'Club Sandwich', image: require('./im/clubsandwhich.jpg'), price: 7 },
  { id: '6', name: 'Egg Sandwich', image: require('./im/eggsandwhich.jpg'), price: 6 },
];
...
export default function DominosScreen() {
  ...
  const handleSkip = () => {
    router.push('/dominosgoole'); // ⭐ navigate to Dominos reviews page
  };
  ...
  const confirmOrder = () => {
    ...
    alert('Dominos order placed successfully ✅');
  };
  ...
  return (
    <ScrollView style={styles.container}>
      {/* Restaurant Info */}
      <Image source={require('./im/dominos.jpg')} style={styles.restaurantImage} />
      <Text style={styles.restaurantName}>Dominos</Text>
      <Text style={styles.description}>Delicious pizzas baked to perfection!</Text>
